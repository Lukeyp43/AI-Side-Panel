...
<sub>**Privacy:** This add-on collects anonymous usage analytics (platform, features used, IP for rate limiting). No personal data or card content is sent.</sub>

<sub>**License:** Proprietary — see [LICENSE.txt](LICENSE.txt). Free to install and use, but source code may not be copied, modified, or redistributed without permission.</sub>
